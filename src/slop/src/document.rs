...
use crate::rbx::{self, DataModel, Game, JobAccess, LaunchMode, SecurityIdentity};
...
impl Document {
    pub fn new() -> Self {
        Self { marshaller: std::ptr::null_mut(), game: None, started_handlers: Vec::new() }
    }
    ...
    fn execute_script(
        ...
        let Some(dm) = game.get_data_model() else { return };
